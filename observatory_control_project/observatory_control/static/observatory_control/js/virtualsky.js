...
function VirtualSky(input){
	...
	this.setLongitude(88.0996);
	this.setLatitude(41.8685);
	...
	this.file = {
		stars: this.dir+"celestial-objects/stars.json",                 // Data for faint stars - 54 kB
		lines: this.dir+"celestial-objects/lines_latin.json",           // Data for constellation lines - 12 kB
		boundaries: this.dir+"celestial-objects/boundaries.json",       // Data for constellation boundaries - 20 kB
		showers: this.dir+"celestial-objects/showers.json",             // Data for meteor showers - 4 kB
		galaxy: this.dir+"celestial-objects/galaxy.json",               // Data for milky way - 12 kB
	...
	S('head').append('<style type="text/css">'+
		v+'_help { '+p+':10px;'+c+':black;'+r+'} '+
		v+'_help ul { list-style:none;margin:0px;'+p+':0px; } '+
		v+'_infobox { '+c+':'+a+';color:black;'+p+':5px;'+r+bs+'} '+
		v+'_infobox img {} '+
		v+'_infocredit {color:black;float:left;font-size:0.8em;'+p+':5px;position:absolute;} '+
		...
		v+'button { '+k+':white; width: 1.5em; line-height: 1.5em; color: '+a+'; cursor: pointer; display: block; padding: 0px; text-align: center; color: #000000; font-size: 1em; } '+
		v+'_help_key:active{ '+k+':white; } '+
		...
		v+'_help_key { cursor:pointer;display:inline-block;text-align:center;'+
			...
			p+'-box;color:white;border:1px solid #e0e0e0;border-bottom-width:2px;white-space:nowrap;font-family:monospace'+
...
VirtualSky.prototype.drawImmediate = function(proj){
	...
	if(this.credit){
		...
		var metric_credit = this.drawText(credit,this.padding,this.tall-this.padding,this.color='grey');
	...
	if(this.container.find('.'+this.id+'_btn_help').length == 0){
		this.container.append('<div class="'+this.id+'_btn_help virtualskybutton" id="helpBtn" title="'+this.getPhrase('help')+'">?</div>');
